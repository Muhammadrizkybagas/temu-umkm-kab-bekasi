...
export default function EditUMKMPage({
  ...
  // State Dropdown Kecamatan Searchable
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center min-h-100">
        <p className="text-sm font-medium text-slate-400">Memuat data UMKM...</p>
      </div>
    );
  }
    ...
    <div className="max-w-4xl mx-auto pb-12">
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl sm:text-2xl font-bold text-slate-800">Edit UMKM</h1>
            <p className="text-xs sm:text-sm text-slate-500 font-medium">Perbarui informasi data pelaku usaha</p>
          </div>
        </div>
      </div>
          ...
          <div className="relative" ref={districtRef}>
            ...
            >
              ...
              <Icon 
                path={mdiChevronDown} 
                size={0.75} 
                className={`text-slate-400 transition-transform duration-200 ${districtOpen ? "rotate-180" : ""}`} 
              />
            </button>
