    ...
    <div className="max-w-3xl mx-auto">
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-textMain">Tambah UMKM Baru</h1>
            <p className="text-sm text-gray-500">Isi formulir data UMKM Kabupaten Bekasi</p>
          </div>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="bg-white p-6 rounded-xl border border-gray-100 shadow-soft space-y-4">
        ...
        <div>
          ...
          {form.logoUrl && (
            <p className="text-xs text-emerald-600 mt-1">Logo terunggah: {form.logoUrl}</p>
          )}
        </div>
        ...
        <div>
          ...
          <select
            ...
            onChange={handleChange}
            className="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary/50 bg-white"
          >
