  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.success) {
        Swal.fire({
          title: "Berhasil!",
          text: status === "Published" ? "Artikel berhasil dipublikasikan." : "Artikel disimpan sebagai draft.",
          icon: "success",
          timer: 1500,
    ...
    <div className="max-w-5xl mx-auto pb-16">
      ...
      <div className="mb-6 flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500">Buat dan publikasikan berita atau informasi terbaru untuk UMKM.</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 md:p-8 space-y-6">
          ...
          <div>
            ...
            <input
              ...
              placeholder="Contoh: Pelatihan Digital Marketing untuk UMKM Bekasi..."
          ...
          <div>
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 p-4 bg-gray-50/60 border border-dashed border-gray-300 rounded-2xl">
              ...
              <div className="space-y-1 grow">
                ...
                {thumbnailFile && (
                  <p className="text-xs font-medium text-primary mt-1">Terpilih: {thumbnailFile.name}</p>
                )}
              </div>
            </div>
          </div>
        ...
        <div className="flex items-center justify-end gap-3 pt-4">
          ...
          <button type="submit" disabled={submitting} className="px-8 py-3 bg-primary hover:bg-[#2489b5] text-white rounded-xl text-sm font-bold shadow-md shadow-primary/20 transition-all flex items-center gap-2 disabled:opacity-70">
            ...
            {submitting ? "Memproses..." : status === "Published" ? "Publikasikan Artikel" : "Simpan Draft"}
          </button>
        </div>
